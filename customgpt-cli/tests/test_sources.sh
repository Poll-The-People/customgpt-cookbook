...
# Test create source
print_header "Testing create-source command"
# SOURCE_ID=$(customgpt-cli create-source --project-id $PROJECT_ID --sitemap-path $SITEMAP_URL --file-data-retension --is-ocr-enabled --is-anonymized | grep -A10 '"sitemaps": \[' | grep -o '"id": [0-9]*' | head -1 | awk '{print $2}')
SOURCE_ID=95837
echo "SOURCE_ID: $SOURCE_ID"
check_success "Create source"
